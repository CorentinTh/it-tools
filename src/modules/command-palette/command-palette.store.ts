...
export const useCommandPaletteStore = defineStore('command-palette', () => {
  ...
  const searchOptions: PaletteOption[] = [
    ...
    },
    {
      ...
      href: 'https://github.com/HuangTechHub/tech-tools',
      category: 'External',
      description: 'View the source code of tech-tools on Github.',
      keywords: ['github', 'repo', 'repository', 'source', 'code'],
      icon: GithubIcon,
    },
    {
      name: 'Report a bug or an issue',
      description: 'Report a bug or an issue to help improve tech-tools.',
      href: 'https://github.com/HuangTechHub/tech-tools/issues/new/choose',
      category: 'Actions',
    ...
    {
      name: 'About',
      description: 'Learn more about Tech-Tools.',
      to: '/about',
      category: 'Pages',
